      ...
      <>
        ...
        >
          <Box border={"0.5px solid black"} h={"34em"} w={"60%"}>
            <Text w={"30%"} ml={"3em"} fontWeight={"bold"} fontSize={"25px"}>
              Ship to
            </Text>
            ...
            <Box w={"50%"} h={"2em"} pt={"3.5em"}>
              <Input required maxLength={10} w={"60%"} ml={"4.5em"} placeholder="Phone Number" />
            </Box>
            <Box pt={"3.5em"} w={"48%"}>
              <Checkbox ml={"5em"}>Save As Default Shipping Address</Checkbox>
            </Box>
          </Box>
        ...
        <Box mt={"2em"} w={"100%"}>
          <Text ml={"6em"} fontWeight={"bold"} fontSize={"25px"}>
            Payment
          </Text>
        </Box>
        <Box
        ...
        <Box mt={"2em"} w={"30%"}>
          <Text ml={"10em"} fontWeight={"light"} fontSize={"16px"}>
            PAYMENT METHOD :
          </Text>
        </Box>
        <Box
